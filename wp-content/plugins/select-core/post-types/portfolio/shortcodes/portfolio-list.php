...
class PortfolioList implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        if(function_exists('vc_map')) {
            ...
            if(qode_core_theme_installed()) {
                $icons_array = \UltimaQodefIconCollections::get_instance()->getVCParamsArray();
            }
            ...
            vc_map(array(
                    ...
                    'params'                    => array(
                        ...
                        array(
                            ...
                            'dependency'  => array(
                                'element' => 'type',
                                'value'   => array('standard', 'gallery', 'gallery-space')
                            )
                        ),
                        array(
                            'type' => 'dropdown',
                        ...
                        array(
                            'type'        => 'dropdown',
                            'heading'     => esc_html__('Text Skin', 'select-core'),
                            'param_name'  => 'text_skin',
                            'value'       => array(
                                esc_html__('Dark', 'select-core')  => 'text-dark',
                                esc_html__('Light', 'select-core') => 'text-light'
                            ),
                            'admin_label' => true,
                            'description' => esc_html__('Default value is Dark', 'select-core'),
                        ...
                        array(
                            'type'        => 'dropdown',
                            'heading'     => esc_html__('Portfolio Link Target', 'select-core'),
                            'param_name'  => 'target',
                            'value'       => array(
                        ...
                        array(
                            ...
                            'admin_label' => true,
                            'description' => esc_html__('Default value is four', 'select-core'),
                            'dependency'  => array('element' => 'type', 'value' => array('masonry'))
                        ),
                        array(
                            'type'        => 'dropdown',
    ...
    public function render($atts, $content = null) {
        ...
        if($query_results->have_posts()):
            ...
            while($i <= $columns_num) {
                $i++;
                if($columns != 1 && ($type == 'standard' || $type == 'gallery-space')) {
    ...
    public function getPortfolioIconsHtml($params) {
        ...
        if(function_exists('ultima_qodef_like_portfolio_list')) {
            $html .= ultima_qodef_like_portfolio_list($id);
        }
    ...
    public function getPortfolioClasses($params) {
        ...
        if($type == "masonry") {
            switch($masonry_columns):
                case 'four':
                    $classes[] = 'qodef-ptf-masonry-four-columns';
                    break;
                case 'five':
                    $classes[] = 'qodef-ptf-masonry-five-columns';
                    break;
            endswitch;
        }
        ...
        if($type == "masonry") {
            switch($text_skin):
                case 'text-dark':
                    $classes[] = 'qodef-ptf-masonry-text-dark';
                    break;
                case 'text-light':
                    $classes[] = 'qodef-ptf-masonry-text-light';
                    break;
            endswitch;
        }
    ...
    public function getImageSize($params) {
        ...
        if($type == 'standard' || $type == 'gallery' || $type == 'gallery-space') {
            if(!empty($params['image_size'])) {
                ...
                switch($image_size) {
                    case 'landscape':
                        $thumb_size = 'ultima_qodef_landscape';
                        break;
                    case 'portrait':
                        $thumb_size = 'ultima_qodef_portrait';
                        break;
                    case 'square':
                        $thumb_size = 'ultima_qodef_square';
                        break;
                    case 'full':
                        $thumb_size = 'full';
                        break;
            ...
            switch($masonry_size):
                default :
                    ...
                    break;
                case 'large_width' :
                    $thumb_size = 'ultima_qodef_large_width';
                    break;
                case 'large_height' :
                    $thumb_size = 'ultima_qodef_large_height';
                    break;
                case 'large_width_height' :
                    $thumb_size = 'ultima_qodef_large_width_height';
                    break;
            endswitch;
        }
