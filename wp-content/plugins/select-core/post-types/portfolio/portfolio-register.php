...
class PortfolioRegister implements PostTypeInterface {
	...
	private function registerPostType() {
		global $ultima_qodef_Framework, $ultima_qodef_options;
		...
		if ( qode_core_theme_installed() ) {
			$menuPosition = $ultima_qodef_Framework->getSkin()->getMenuItemPosition( 'portfolio' );
			$menuIcon     = $ultima_qodef_Framework->getSkin()->getMenuIcon( 'portfolio' );

			if ( isset( $ultima_qodef_options['portfolio_single_slug'] ) ) {
				if ( $ultima_qodef_options['portfolio_single_slug'] != "" ) {
					$slug = $ultima_qodef_options['portfolio_single_slug'];
				}
			}
		}
