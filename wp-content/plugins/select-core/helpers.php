...
if(!function_exists('ultima_qodef_add_user_custom_fields')) {
    function ultima_qodef_add_user_custom_fields($user_contact)
    {
    ...
    add_filter('user_contactmethods', 'ultima_qodef_add_user_custom_fields');
}
