<?php
namespace UltimaQodef\Modules\Shortcodes\IconListItem;
...
class IconListItem implements ShortcodeInterface {
    ...
    private function getIconStyle($params) {
        ...
        if(!empty($params['icon_size'])) {
            $iconStylesArray[] = 'font-size:'.ultima_qodef_filter_px($params['icon_size']).'px';
        }
    ...
    private function getTitleStyle($params) {
        ...
        if(!empty($params['title_size'])) {
            $titleStylesArray[] = 'font-size:'.ultima_qodef_filter_px($params['title_size']).'px';
        }

        if(!empty($params['title_weight'])) {
            $titleStylesArray[] = 'font-weight:'.$params['title_weight'];
        }
