<?php
namespace ultimaQodef\Modules\Shortcodes\CustomFont;
        ...
        vc_map(array(
            ...
            'params'                    => array(
                ...
                array(
                    ...
                    "value"       => ultima_qodef_get_font_style_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    ...
                    "value"       => ultima_qodef_get_font_weight_array(),
                    "save_always" => true
                ),
                array(
                    "type"       => "textfield",
                ...
                array(
                    ...
                    "value"       => ultima_qodef_get_text_transform_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                ...
                array(
                    "type"        => "textarea",
                    "heading"     => esc_html__('Typed ending word 1', 'select-core'),
                ...
                array(
                    "type"        => "textarea",
                    "heading"     => esc_html__('Typed ending word 2', 'select-core'),
                ...
                array(
                    "type"        => "textarea",
                    "heading"     => esc_html__('Typed ending word 3', 'select-core'),
