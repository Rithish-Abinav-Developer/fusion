<?php
namespace UltimaQodef\Modules\Shortcodes\Button;
 ...
 * @package UltimaQodef\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
                ...
                'params'                    => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            'param_name'  => 'padding',
                            'description' => esc_html__('Insert padding in format: 0px 10px 0px 10px', 'select-core'),
                            'admin_label' => true,
                            'group'       => esc_html__('Design Options', 'select-core')
                        ),
                        array(
                            ...
                            'param_name'  => 'margin',
                            'description' => esc_html__('Insert margin in format: 0px 0px 10px 0px', 'select-core'),
                            'admin_label' => true,
                            'group'       => esc_html__('Design Options', 'select-core')
                        )
                    )
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['border_width'])) {
            $styles[] = 'border-width: '.ultima_qodef_filter_px($params['border_width']).'px';
        }

        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.ultima_qodef_filter_px($params['font_size']).'px';
        }
        ...
        if(!empty($params['letter_spacing'])) {
            $styles[] = 'letter-spacing: '.ultima_qodef_filter_px($params['letter_spacing']).'px';
        }

        if(!empty($params['border_radius'])) {
            $styles[] = 'border-radius: '.ultima_qodef_filter_px($params['border_radius']).'px';
        }
