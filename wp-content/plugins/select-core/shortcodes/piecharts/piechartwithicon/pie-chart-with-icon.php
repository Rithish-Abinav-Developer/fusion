<?php
namespace UltimaQodef\Modules\Shortcodes\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
    ...
    private function getPieChartIcon($params) {
        ...
        $pie_chart_icon = ultima_qodef_icon_collections()->renderIcon($params[$icon], $params['icon_pack'], $iconStyles);
