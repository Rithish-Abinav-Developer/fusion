<?php
namespace UltimaQodef\Modules\Shortcodes\UnorderedList;
...
class UnorderedList implements ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        $html    = '<div class="qodef-unordered-list '.$list_item_classes.'" '.ultima_qodef_get_inline_style($list_style).'>'.do_shortcode($content).'</div>';
