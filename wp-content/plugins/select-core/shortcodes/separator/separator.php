<?php
namespace UltimaQodef\Modules\Shortcodes\Separator;
...
class Separator implements ShortcodeInterface {
    ...
    private function getSeparatorStyle($params) {
        ...
        if($params['border_radius'] !== '') {
            $separator_style[] = 'border-radius: '.$params['border_radius'].'px';
        }
        if($params['width'] !== '') {
            if(ultima_qodef_string_ends_with($params['width'], '%') || ultima_qodef_string_ends_with($params['width'], 'px')) {
        ...
        if($params['top_margin'] !== '') {
            if(ultima_qodef_string_ends_with($params['top_margin'], '%') || ultima_qodef_string_ends_with($params['top_margin'], 'px')) {
        ...
        if($params['bottom_margin'] !== '') {
            if(ultima_qodef_string_ends_with($params['bottom_margin'], '%') || ultima_qodef_string_ends_with($params['bottom_margin'], 'px')) {
