<?php
namespace UltimaQodef\Modules\Shortcodes\Clients;
        ...
        vc_map(array(
            ...
            'params'                  => array(
                array(
                    ...
                    'param_name'  => 'columns',
                    'value'       => array(
                        esc_html__('Two', 'select-core')   => 'two-columns',
                        esc_html__('Three', 'select-core') => 'three-columns',
                        esc_html__('Four', 'select-core')  => 'four-columns',
                        esc_html__('Five', 'select-core')  => 'five-columns',
                        esc_html__('Six', 'select-core')   => 'six-columns'
                    ),
                    'save_always' => true,
                    'description' => ''
                )
