<?php
namespace UltimaQodef\Modules\Shortcodes\Message;
...
class Message implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                \UltimaQodefIconCollections::get_instance()->getVCParamsArray(array(
                    'element' => 'type',
                    'value'   => 'with_icon'
                )),
                array(
    ...
    public function render($atts, $content = null) {
        ...
        $params['text_styles']       = $this->getTextColor($params);
    ...
    private function getTextColor($params) {
        ...
        if(!empty($params['text_color'])) {
            $iconStyles[] = 'color: '.$params['text_color'];
        }
