<?php
namespace UltimaQodef\Modules\Shortcodes\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
    ...
    public function render($atts, $content = null) {
        ...
        $html .= '<div ' . ultima_qodef_get_class_attribute($elements_holder_class) . ' ' . ultima_qodef_get_inline_attr($elements_holder_style, 'style'). '>';
