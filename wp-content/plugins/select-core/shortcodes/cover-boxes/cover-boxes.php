<?php
namespace UltimaQodef\Modules\Shortcodes\CoverBoxes;
...
class CoverBoxes implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
                'name'                      => esc_html__('Cover Boxes', 'select-core'),
                'base'                      => $this->getBase(),
                ...
                'params'                    => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            "value"      => "",
                            'group'      => esc_html__('Cover box 1', 'select-core'),
                            'dependency' => array('element' => 'link1', 'not_empty' => true)
                        ),
                        array(
                            "type"        => "dropdown",
                            "holder"      => "div",
                    ...
                    array(
                        ...
                        array(
                            ...
                            "value"      => "",
                            'group'      => esc_html__('Cover box 2', 'select-core'),
                            'dependency' => array('element' => 'link2', 'not_empty' => true)
                        ),
                        array(
                            "type"        => "dropdown",
                            "holder"      => "div",
                    ...
                    array(
                        ...
                        array(
                            ...
                            "value"      => "",
                            'group'      => esc_html__('Cover box 3', 'select-core'),
                            'dependency' => array('element' => 'link3', 'not_empty' => true)
                        ),
                        array(
                            "type"                          => "dropdown",
                            "holder"                        => "div",
                            "class"                         => "",
                            esc_html__('heading', 'select-core') => esc_html__('Target 3', 'select-core'),
                            "param_name"                    => "target3",
                            "value"                         => array(
                                ''                            => '',
                                esc_html__('Self', 'select-core')  => "_self",
    ...
    public function render($atts, $content = null) {
        ...
        $args = array(
            ...
            "image1"         => "",
            "link1"          => "",
            "link_label1"    => "Read More",
            "target1"        => "",
            "title2"         => "",
            "text2"          => "",
            "image2"         => "",
            "link2"          => "",
            "link_label2"    => "Read More",
            "target2"        => "",
            "title3"         => "",
            "text3"          => "",
            "image3"         => "",
            "link3"          => "",
            "link_label3"    => "Read More",
            "target3"        => ""
        );
