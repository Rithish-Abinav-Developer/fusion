<?php
namespace UltimaQodef\Modules\Shortcodes\IconWithText;

use UltimaQodef\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package UltimaQodef\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
                ...
                array(
                    ...
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__('Behind Title', 'select-core')    => 'behind-title',
                        ),
                    ...
                    array(
                        ...
                        'dependency'  => array(
                            ...
                            'value'   => array('top', 'left', 'right', 'left-from-title')
                        ),
                        'description' => esc_html__('This attribute doesn\'t work when Icon Position is Behind Title. In this case Icon Type is Normal.', 'select-core'),
                    ),
                    array(
                        'type'        => 'dropdown',
        ...
        if(!empty($params['icon_position'])) {
            switch($params['icon_position']) {
                ...
                case 'left-from-title':
                    ...
                    break;
                case 'behind-title':
                    $classes[] = 'qodef-iwt-behind-title';
                    break;
                default:
                    break;
            }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.ultima_qodef_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.ultima_qodef_filter_px($params['text_right_padding']).'px';
        }
