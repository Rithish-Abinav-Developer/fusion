<div <?php ultima_qodef_class_attribute( $holder_classes ); ?>  <?php ultima_qodef_inline_style( $holder_parameters ); ?>>
    ...
    <div class="qodef-iwt-content-holder" <?php ultima_qodef_inline_style( $content_styles ); ?>>
