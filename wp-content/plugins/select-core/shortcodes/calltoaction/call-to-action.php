<?php
namespace UltimaQodef\Modules\Shortcodes\CallToAction;
...
class CallToAction implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        $call_to_action_button_IconCollections = ultima_qodef_icon_collections()->iconCollections;
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                ultima_qodef_icon_collections()->getVCParamsArray(array(
                    'element' => 'type',
                ...
                array(
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Default Text Font Weight', 'select-core'),
                        'param_name'  => 'text_weight',
                        'description' => esc_html__('Font weight for p tag', 'select-core'),
                        'group'       => esc_html__('Design Options', 'select-core'),
                        'value'       => array(
                            ...
                            esc_html__('Regular', 'select-core')  => '400',
                            ...
                            esc_html__('Black', 'select-core')  => '900'
                        )
                    ),
                    array(
                        'type'        => 'dropdown',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Hover Type', 'select-core'),
                        'param_name'  => 'hover_type',
                        'value'       => array(
                            esc_html__('Default', 'select-core')     => '',
                            esc_html__('Sweep', 'select-core')     => 'sweep',
                            esc_html__('Scale', 'select-core')       => 'scale',
                        ),
                        'save_always' => true,
                        'group'       => esc_html__('Button Options', 'select-core'),
                        'admin_label' => true
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Button Font Size (px)', 'select-core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Font Weight', 'select-core'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Border Radius (px)', 'select-core'),
                    ...
                    array(
                        ...
                        'value'       => array_merge(array('No Icon' => ''), ultima_qodef_icon_collections()->getIconCollectionsVC()),
                        'save_always' => true,
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes'))
                    )
                ),
    ...
    public function render($atts, $content = null) {
        ...
        $args = array_merge($args, ultima_qodef_icon_collections()->getShortcodeParams(), $call_to_action_icons_form_fields);
    ...
    private function getContentStyles($params) {
        ...
        if($params['text_weight'] !== '') {
            $content_styles[] = 'font-weight: '.$params['text_weight'];
        }
    ...
    private function getCallToActionIcon($params) {
        ...
        if(!empty($params[$icon])) {
            $call_to_action_icon = ultima_qodef_icon_collections()->renderIcon($params[$icon], $params['icon_pack'], $iconStyles);
        }
    ...
    private function getButtonParameters($params) {
        ...
        if(!empty($params['button_icon_pack'])) {
            ...
            $iconPackName                       = ultima_qodef_icon_collections()->getIconCollectionParamNameByKey($params['button_icon_pack']);
        ...
        if(!empty($params['button_border_radius'])) {
            $button_params_array['border_radius'] = $params['button_border_radius'];
        }

        if(!empty($params['button_border_width'])) {
            $button_params_array['border_width'] = $params['button_border_width'];
        }
