<?php
if ( ! function_exists( 'ultima_qodef_init_google_fonts_array' ) ) {
    function ultima_qodef_init_google_fonts_array() {
            ...
            $ultima_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'ultima_qodef_init_google_fonts_array');
}