...
class EventSchedule {
    ...
    public function loadScripts() {
        $settings = array(
            'locale' => get_locale(),
            'imageType' => get_field('2code_image_format', 'options'),
            'dateFormat' => get_field('2code_date_format', 'options'),
            'timeFormat' => get_field('2code_time_format', 'options'),
            'dayFormat' => get_field('2code_day_format', 'options'),
        );
