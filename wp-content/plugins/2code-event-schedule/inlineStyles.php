...
$color = get_field('2code_color', 'options');
$eventBorder = get_field('2code_event_separator', 'options');

$imgFormat = get_field('2code_image_format', 'options');
$dateHidden = get_field('2code_date_hidden', 'options');
