...
$size = get_field('2code_module_size', 'options');
$socialPlacement = get_field('2code_social_placement', 'options');
$dayTitle = get_field('2code_day_title', 'options');
?>
...
$daysNum = $daysNum ?? 4;
$slides = min( $cnt, $daysNum );

$showLocations = get_field('2code_locations_mode', 'options');
$showLocations = $showLocations ?? false;

$keepAccordionsOpen = get_field('2code_accordion_behavior', 'options');
$keepAccordionsOpen = $keepAccordionsOpen ?? false;

$openFirstAccordion = get_field('2code_accordion_open_first', 'options');
$openFirstAccordion = $openFirstAccordion ?? false;
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('.event-schedule').schedule({
            showLocations: <?php echo $showLocations ? 'true' : 'false'; ?>,
            keepAccordionsOpen: <?php echo $keepAccordionsOpen ? 'true' : 'false'; ?>,
            openFirstAccordion: <?php echo $openFirstAccordion ? 'true' : 'false'; ?>
        });
