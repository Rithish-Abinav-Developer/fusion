...
<html <?php language_attributes(); ?>>
    <head>
        <?php
        /**
         * ultima_qodef_header_meta hook
         *
         * @see ultima_qodef_header_meta() - hooked with 10
         * @see qode_user_scalable_meta() - hooked with 10
         */
        if (!ultima_qodef_is_ajax_request()) do_action('ultima_qodef_header_meta');
        ?>
				...
				<div class="qodef-full-width">
					<div class="qodef-full-width-inner">
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							<?php if(($ultima_qodef_sidebar == 'default')||($ultima_qodef_sidebar == '')) : ?>
								<?php the_content(); ?>
								<?php do_action('ultima_qodef_page_after_content'); ?>
							<?php elseif($ultima_qodef_sidebar == 'sidebar-33-right' || $ultima_qodef_sidebar == 'sidebar-25-right'): ?>
								<div <?php echo ultima_qodef_sidebar_columns_class(); ?>>
							...
							<?php elseif($ultima_qodef_sidebar == 'sidebar-33-left' || $ultima_qodef_sidebar == 'sidebar-25-left'): ?>
								<div <?php echo ultima_qodef_sidebar_columns_class(); ?>>
