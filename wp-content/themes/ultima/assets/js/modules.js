    ...
    */
    ...
    function qodefSearch() {
        ...
        if (searchOpener.length > 0) {
            ...
            searchOpener.each(function () {
                ...
                if (typeof thisOpener.data('hover-color') !== 'undefined') {
                    ...
                    searchOpener.on('mouseenter', {searchOpener: thisOpener, color: hoverColor}, changeSearchColor);
                    searchOpener.on('mouseleave', {searchOpener: thisOpener, color: originalColor}, changeSearchColor);
                }
            });
        ...
        function qodefFullscreenSearch() {
            ...
            var fullScreenSearchClose = function () {
            ...
            var fullScreenSearchOpen = function () {
            ...
            searchOpener.on('click', function (e) {
                ...
                $(document).mouseup(function (e) {
                    if (searchHolder.hasClass('qodef-animate')) {
                        var container = $(".qodef-form-holder"); //click away
...
(function ($) {
    ...
    shortcodes.qodefTeamSlider = qodefTeamSlider;
    ...
    shortcodes.qodefCheckFullscreenSliderForHeaderStyle = qodefCheckFullscreenSliderForHeaderStyle;
    ...
    */
        ...
        var iconAnimation = function (icon) {
            if (icon.hasClass('qodef-icon-animation')) {
                ...
                icon.appear(function () {
                    ...
                    icon.parents('.qodef-iwt-content-holder').find(".qodef-iwt-title-holder").addClass("qodef-iwt-title-animation-show");
                    icon.parents('.qodef-iwt-content-holder').find(".qodef-iwt-text-holder").addClass("qodef-iwt-text-animation-show");
                }, {accX: 0, accY: qodefGlobalVars.vars.qodefElementAppearAmount});
            }
        };
    ...
    function qodefTeamSlider() {
        var teamSliders = $('.qodef-team-slider');
        ...
        var buttonHoverAnimationParams = function (button) {
            if (button.find('.qodef-hover-background').length) {
                if ((button.css('borderTopRightRadius') !== '')) { //borderTopRightRadius due to Mozilla not getting it
                    ...
                    if (button.hasClass('qodef-btn-hover-scale')) {
                        button.mouseenter(function () {
                            $(this).find('.qodef-hover-background').css('border-radius', borderRadius);
                        });
                        button.mouseleave(function () {
                            $(this).find('.qodef-hover-background').css('border-radius', '100%');
                        });
                    }
                ...
                if ((button.css('border-left-width') !== '')) {
                    ...
                    if (button.hasClass('qodef-btn-hover-scale')) {
                        button.find('.qodef-hover-background').css('top', -borderWidth);
                        button.find('.qodef-hover-background').css('left', -borderWidth);
    ...
    */
        ...
        if (customFont.length) {
            customFont.each(function () {
                ...
                if (typeof thisCustomFont.data('line-height') !== 'undefined' && thisCustomFont.data('line-height') !== false) {
                    ...
                    if (lineHeight > 100 && qodef.windowWidth < 1500) {
                        lineHeight = '1em';
                    } else if (lineHeight > 70 && qodef.windowWidth < 1300) {
                        lineHeight = '1.1em';
    ...
    /**
     * Initializes fullscreen sections
     */

    function qodefFullscreenSections() {

        var fullscreenSections = $('.qodef-fullscreen-sections');

        if (fullscreenSections.length > 0) {
            fullscreenSections.each(function () {
                var thisFullscreenSections = $(this);
                var section = thisFullscreenSections.find('.qodef-fullscreen-sections-item');
                var slide = thisFullscreenSections.find('.qodef-fullscreen-sections-item-slide');
                var headerHeight = 0;
                var isDragging = false;

                if (thisFullscreenSections.hasClass('qodef-paspartue') && qodef.windowWidth > 1024) {
                    headerHeight = qodefGlobalVars.vars.qodefMenuAreaHeight;
                }

                thisFullscreenSections.fullpage({
                    ...
                    afterRender: function () {
                        if (qodef.windowWidth > 1024) {
                            thisFullscreenSections.swipe({
                                swipeLeft: function () {
                                    thisFullscreenSections.fullpage.moveSlideRight();
                                },
                                swipeRight: function () {
                                    thisFullscreenSections.fullpage.moveSlideLeft();
                                },
                                swipeUp: function () {
                                    thisFullscreenSections.fullpage.moveSectionDown();
                                },
                                swipeDown: function () {
                                    thisFullscreenSections.fullpage.moveSectionUp();
                                },
                                threshold: 20
                            });
                        }
                    },
                    afterLoad: function (anchorLink, index, isResponsive) {
                        if (section.eq(index - 1).hasClass('qodef-slide')) {
                            var activeSection = section.eq(index - 1).find('.qodef-fullscreen-sections-item-slide.active');
                            qodefCheckFullscreenSliderForHeaderStyle(activeSection, activeSection.hasClass('qodef-header-effect'));
                        } else {
                            qodefCheckFullscreenSliderForHeaderStyle(section.eq(index - 1), section.eq(index - 1).hasClass('qodef-header-effect'));
                        }
                        thisFullscreenSections.css('opacity', 1);
                    },
                    afterSlideLoad: function (anchorLink, index, slideIndex, nextSlideIndex) {
                        var loadedSlide = $(this);
                        qodefCheckFullscreenSliderForHeaderStyle(loadedSlide, loadedSlide.hasClass('qodef-header-effect'));
    ...
    function qodefCheckFullscreenSliderForHeaderStyle(section, headerEffect) {

        if ($('.qodef-fullscreen-sections').not('.qodef-disable-sections-header-style-changing').length > 0) {

            var sectionHeaderStyle = "";
            if (section.hasClass('light')) {
                sectionHeaderStyle = 'qodef-light-header';
            }
            if (section.hasClass('dark')) {
                sectionHeaderStyle = 'qodef-dark-header';
            }

            if (sectionHeaderStyle !== "") {
                if (headerEffect) {
                    qodef.body.removeClass('qodef-dark-header qodef-light-header').addClass(sectionHeaderStyle);
                }
            } else {
                if (headerEffect) {
    ...
    /**
     * Initializes info boxes hover shortcode
     * @type {Function}
     */
    function qodefInitInfoBox() {

        var infoBox = $('.qodef-info-box-holder.info-box-icon-top');

        if (infoBox.length > 0) {
            infoBox.each(function () {
                var thisInfoBox = $(this);
                var contentHeight;
                var content = thisInfoBox.find('.qodef-info-box-content');
                var visibleInfo = thisInfoBox.find('.qodef-info-box-visible-content');
                var hiddenInfo = thisInfoBox.find('.qodef-info-box-invisible-content');
    ...
    function qodefInitPortMixItUp(container) {
        ...
        holderInner.mixItUp({
            ...
            animation: {
                duration: 400,
                effects: 'fade translateY(30%) stagger(150ms) scale(0.5)',
                easing: 'ease'
            }
        ...
        if (portSlider.length) {
            portSlider.each(function () {
                ...
                function onTranslate(event) {
                    sliderWrapper.find(".qodef-portfolio-link").css("z-index", 0);
                    sliderWrapper.find(".qodef-portfolio-link").css("cursor", "pointer");
                }

                function onTranslated(event) {
                    sliderWrapper.find(".qodef-portfolio-link").css("z-index", 2);
                    sliderWrapper.find(".qodef-portfolio-link").css("cursor", "pointer");
                }
    ...
    var qodefSlider = qodef.modules.shortcodes.qodefSlider = function () {
        ...
        var initPeek = function (slider) {
            if (slider.hasClass('qodef-slide-peek')) {
                ...
                nav_arrows.on('mouseneter', function () {
