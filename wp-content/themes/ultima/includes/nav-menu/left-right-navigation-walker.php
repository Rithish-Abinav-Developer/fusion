...
/**
 * Custom WP_NAV_MENU function for left navigation
 */
if ( ! class_exists( 'UltimaQodefLeftRightNavigationWalker' ) ) {
	class UltimaQodefLeftRightNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $item->hide == "" ) {
				...
				$item_output .= $item_structure; // render menu item content
