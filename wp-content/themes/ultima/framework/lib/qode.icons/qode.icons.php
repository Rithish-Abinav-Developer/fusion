...
/*
  Class: UltimaQodefIconCollections
...
class UltimaQodefIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection( 'font_awesome', new UltimaQodefIconsFontAwesome( "Font Awesome", "fa_icon" ) );
		$this->addIconCollection( 'font_elegant', new UltimaQodefIconsFontElegant( "Font Elegant", "fe_icon" ) );
		$this->addIconCollection( 'ion_icons', new UltimaQodefIonIcons( "Ion Icons", "ion_icon" ) );
		$this->addIconCollection( 'linea_icons', new UltimaQodefLineaIcons( 'Linea Icons', 'linea_icon' ) );
		$this->addIconCollection( 'simple_line_icons', new UltimaQodefSimpleLineIcons( 'Simple Line Icons',
			'simple_line_icons' ) );
		$this->addIconCollection( 'dripicons', new UltimaQodefDripicons( 'Dripicons', 'dripicon' ) );
	}
	...
	public function getIconCollectionIcons( iUltimaQodefIconCollection $collection ) {
	...
	public function enqueueStyles() {
		if ( is_array( $this->iconCollections ) && count( $this->iconCollections ) ) {
			foreach ( $this->iconCollections as $collection_key => $collection_obj ) {
				wp_enqueue_style( 'ultima-qodef-' . $collection_key, $collection_obj->styleUrl );
			}
		}
	}
...
if ( ! function_exists( 'ultima_qodef_activate_theme_icons' ) ) {

	function ultima_qodef_activate_theme_icons() {
		global $ultima_qodef_IconCollections;
		$ultima_qodef_IconCollections = UltimaQodefIconCollections::get_instance();
	}

	add_action( 'after_setup_theme', 'ultima_qodef_activate_theme_icons' );
}