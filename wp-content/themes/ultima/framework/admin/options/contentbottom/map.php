...
if(!function_exists('ultima_qodef_content_bottom_options_map')) {

    function ultima_qodef_content_bottom_options_map() {
        ...
        $panel_content_bottom = ultima_qodef_add_admin_panel(
            array(
                'page'  => '_content_bottom_page',
                'name'  => 'panel_content_bottom',
                'title' => esc_html__('Content Bottom Area', 'ultima')
            )
        );
        ...
        $enable_content_bottom_area_container = ultima_qodef_add_admin_container(
            array(
                'parent'          => $panel_content_bottom,
        ...
        ultima_qodef_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Widget Area to Display', 'ultima'),
            'description'   => esc_html__('Choose a Content Bottom widget area to display', 'ultima'),
    ...
    add_action('ultima_qodef_options_map', 'ultima_qodef_content_bottom_options_map', 20);
