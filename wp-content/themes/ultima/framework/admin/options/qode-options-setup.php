...
add_action('after_setup_theme', 'ultima_qodef_admin_map_init', 0);

function ultima_qodef_admin_map_init() {

    do_action('ultima_qodef_before_options_map');
    ...
    do_action('ultima_qodef_options_map');

    do_action('ultima_qodef_after_options_map');
