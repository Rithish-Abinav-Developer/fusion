...
if(!function_exists('ultima_qodef_configure_visual_composer')) {
    /**
     * Configuration for Visual Composer
     * Hooks on vc_after_init action
     */
    function ultima_qodef_configure_visual_composer() {
    ...
    add_action('vc_after_init', 'ultima_qodef_configure_visual_composer');

}


if(!function_exists('ultima_qodef_configure_visual_composer_grid_elemets')) {
    ...
    function ultima_qodef_configure_visual_composer_grid_elemets() {
    ...
    add_action('vc_after_init', 'ultima_qodef_configure_visual_composer_grid_elemets');
}


if(!function_exists('ultima_qodef_configure_visual_composer_frontend_editor')) {
    /**
     * Configuration for Visual Composer FrontEnd Editor
     * Hooks on vc_after_init action
     */
    function ultima_qodef_configure_visual_composer_frontend_editor() {
    ...
    add_action('vc_after_init', 'ultima_qodef_configure_visual_composer_frontend_editor');
}
...
if(class_exists('WPBakeryShortCodesContainer')) {
    ...
    class WPBakeryShortCode_Qodef_Team_Slider extends WPBakeryShortCodesContainer {
    }

    class WPBakeryShortCode_Qodef_Team_Slider_Item extends WPBakeryShortCodesContainer {
    }
    ...
    class WPBakeryShortCode_Process_Item extends WPBakeryShortCodesContainer {
    }
    ...
    class WPBakeryShortCode_Qodef_Restaurant_Menu extends WPBakeryShortCodesContainer {
    }

    class WPBakeryShortCode_Qodef_Pricing_Table extends WPBakeryShortCode {
    }

    class WPBakeryShortCode_Qodef_Fullscreen_Sections extends WPBakeryShortCodesContainer {
    }

    class WPBakeryShortCode_Qodef_Fullscreen_Sections_Item extends WPBakeryShortCodesContainer {
    }

    class WPBakeryShortCode_Qodef_Fullscreen_Sections_Item_Slide extends WPBakeryShortCodesContainer {
    }
}


/*** Row ***/
if(!function_exists('ultima_qodef_vc_row_map')) {
    /**
     * Map VC Row shortcode
     * Hooks on vc_after_init action
     */
    function ultima_qodef_vc_row_map() {

        $animations = array(
            esc_html__('No animation', 'ultima')                    => '',
            esc_html__('Elements Shows From Left Side', 'ultima')   => 'qodef-element-from-left',
            esc_html__('Elements Shows From Right Side', 'ultima')  => 'qodef-element-from-right',
            esc_html__('Elements Shows From Top Side', 'ultima')    => 'qodef-element-from-top',
            esc_html__('Elements Shows From Bottom Side', 'ultima') => 'qodef-element-from-bottom',
            esc_html__('Elements Shows From Fade', 'ultima')        => 'qodef-element-from-fade',
        );

        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Row Type', 'ultima'),
            'param_name' => 'row_type',
            'value'      => array(
                'Row'      => 'row',
                'Parallax' => 'parallax'
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Content Width', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Header Style', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Anchor ID', 'ultima'),
            'param_name'  => 'anchor',
            'value'       => '',
            'description' => esc_html__('For example "home"', 'ultima')
        ));

        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Arrow Down ', 'ultima'),
            'param_name' => 'arrow_down',
            "value" => array(
                esc_html__('No', 'ultima') => 'no',
                esc_html__('Yes', 'ultima') => 'yes'
            ),
            'description' => ''
        ));
        ...
        vc_add_param('vc_row', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => esc_html__('Arrow Down Anchor', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'colorpicker',
            'heading' => esc_html__('Arrow Down Color', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Content Aligment', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Video Background', 'ultima'),
            'value'       => array(
                'No'  => '',
                'Yes' => 'show_video'
            ),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Video Overlay', 'ultima'),
            'value'       => array(
                'No'  => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Video Overlay Image (pattern)', 'ultima'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (webm) File URL', 'ultima'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (mp4) file URL', 'ultima'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (ogv) file URL', 'ultima'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Video Preview Image', 'ultima'),
            'value'       => '',
        ...
        vc_add_param("vc_row", array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Full Screen Height', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Vertically Align Content In Middle', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'textfield',
            'class'      => '',
            'heading'    => esc_html__('Section Height', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Parallax Background image', 'ultima'),
            'value'       => '',
            'param_name'  => 'parallax_background_image',
            'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'ultima'),
            'dependency'  => Array('element' => 'row_type', 'value' => array('parallax'))
        ));
        ...
        vc_add_param('vc_row', array(
            'type'       => 'textfield',
            'class'      => '',
            'heading'    => esc_html__('Parallax speed', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('CSS Animation', 'ultima'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Transition delay (ms)', 'ultima'),
    ...
    add_action('vc_after_init', 'ultima_qodef_vc_row_map');
}
