...
$author_info_box = esc_attr(ultima_qodef_options()->getOptionValue('blog_author_info'));
$author_info_email = esc_attr(ultima_qodef_options()->getOptionValue('blog_author_info_email'));
$social_networks = ultima_qodef_get_user_custom_fields($author_id);
	...
	<div class="qodef-author-description">
		...
		<div class="qodef-author-description-inner">
			...
			<div class="qodef-author-description-image">
				<?php echo ultima_qodef_kses_img(get_avatar(get_the_author_meta( 'ID' ), 117)); ?>
			</div>
