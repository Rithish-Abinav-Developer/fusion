<?php ultima_qodef_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
    ...
    <div class="<?php echo esc_attr($blog_classes) ?>" <?php echo esc_attr($blog_data_params) ?> >
        ...
        if($blog_query->have_posts()) : while($blog_query->have_posts()) : $blog_query->the_post();
            ultima_qodef_get_post_format_html($blog_type);
        endwhile;

        else:
            ultima_qodef_get_module_template_part('templates/parts/no-posts', 'blog');
        endif;
...
if(ultima_qodef_options()->getOptionValue('pagination') == 'yes') {
    if(ultima_qodef_options()->getOptionValue('pagination_type') == 'navigation') {
        ?>
        ...
        ultima_qodef_pagination($blog_query->max_num_pages, $blog_page_range, $paged);
    }
}