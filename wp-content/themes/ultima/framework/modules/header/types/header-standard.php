...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = ultima_qodef_filter_px(ultima_qodef_options()->getOptionValue('menu_area_height_header_standard'));
            $this->menuAreaHeight = $menuAreaHeight !== '' ? (int) $menuAreaHeight : (int) 85;

            $mobileHeaderHeight       = ultima_qodef_filter_px(ultima_qodef_options()->getOptionValue('mobile_header_height'));
            $this->mobileHeaderHeight = $mobileHeaderHeight !== '' ? (int) $mobileHeaderHeight : (int) 85;
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = ultima_qodef_get_meta_field_intersect('menu_area_in_grid_header_standard') == 'yes' ? true : false;

        $parameters = apply_filters('ultima_qodef_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } elseif(ultima_qodef_options()->getOptionValue('menu_area_background_color_header_standard') == '') {
            $menuAreaTransparent = ultima_qodef_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
                                   ultima_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') !== '1';
        } else {
            $menuAreaTransparent = ultima_qodef_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   ultima_qodef_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
        }
        ...
        if($menuAreaTransparent) {
            ...
            if(($sliderExists && ultima_qodef_is_top_bar_enabled())
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'qodef_menu_area_background_color_header_standard_meta', true) !== '') {
            ...
            $menuAreaTransparent = ultima_qodef_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
                                   ultima_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') === '0';
        } else {
            $menuAreaTransparent = ultima_qodef_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   ultima_qodef_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
        }
